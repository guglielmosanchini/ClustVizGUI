...
class OPTICS_class(StartingGui):
    ...
    def point_plot_gui(self, X_dict, coords, neigh, processed=None, col='yellow', save_plots=False, ind_fig=None):
        ...
        if save_plots is True:
            self.canvas_up.figure.savefig(appctxt.get_resource("Images/") + '/' + '{}_{:02}/fig_{:02}.png'.format(self.name, self.ind_run, ind_fig))
    ...
    def reach_plot_gui(self, data, save_plots=False, ind_fig=None):
        ...
        if save_plots is True:
            self.canvas_down.figure.savefig(appctxt.get_resource("Images/") + '/' + '{}_{:02}/reachplot_{:02}.png'.format(self.name,
    ...
    def plot_clust_gui(self, save_plots=False):
        ...
        if save_plots is True:
            self.canvas_up.figure.savefig(appctxt.get_resource("Images/") + '/' + '{}_{:02}/fig_fin_{:02}.png'.format(self.name, self.ind_run,
                                                                                       self.ind_extr_fig))
            self.canvas_down.figure.savefig(appctxt.get_resource("Images/") + '/' + '{}_{:02}/reach_plot_fin_{:02}.png'.format(self.name,
                                                                                                self.ind_run,
                                                                                                self.ind_extr_fig))
