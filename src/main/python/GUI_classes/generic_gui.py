...
class StartingGui(QWidget):
    ...
    def checkBoxChangedAction(self, state):
        if Qt.Checked == state:
            ...
            try:
                os.mkdir(appctxt.get_resource("Images/") + '/' + '{}_{:02}'.format(self.name, self.ind_run))
                # print("new folder")
    ...
    def delete_pics(self):
        ...
        if messagebox_reply == QMessageBox.Yes:
            ...
            folders = [fold for fold in os.listdir(appctxt.get_resource("Images/")) if fold.startswith('{}'.format(self.name))]
    ...
    def generate_GIF(self):
        ...
        png_dir = appctxt.get_resource("Images/") + '/' + '{}_{:02}'.format(self.name, self.ind_run)
        images = []
...
class GraphWindow(QMainWindow):
    def __init__(self, example_index):
        ...
        pixmap = QPixmap(appctxt.get_resource("Images/") + '/' + 'ClaransGraphExamples/graph_{:02}.png'.format(example_index))
