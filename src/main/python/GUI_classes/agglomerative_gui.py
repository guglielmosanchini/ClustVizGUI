...
from clustviz.agglomerative import dist_mat_gen, compute_ward_ij, update_mat
...
class AGGLOMERATIVE_class(StartingGui):
    ...
    def agg_clust_mod_gui(self, delay=0):
        ...
        while len(a) > self.n_clust:
            ...
            a.loc[new_cluster_name, :] = new_clust.iloc[0].fillna(0) + new_clust.iloc[
                1
            ].shift(dim1, fill_value=0)
